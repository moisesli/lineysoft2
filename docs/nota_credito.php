          ...
          <h1 class="pt-3">Nota Crédito Electrónica</h1>
          ...
          <pre class="bg-light">
            <code>
              {
                "emisor_operacion": "generar_nota_credito",
                "emisor_id": "1",
                "documento_tipo": "07",
          ...
          <div class="pt-4">
            <h4>2.- Tabla de valores Peticion Json - Nota de Crédito</h4>
          ...
          <h4 class="mt-4">2.- Respuesta JSON de la peticion - Nota de Credito</h4>
          ...
          <div class="">
            <h5>Tabla de valores Respuesta Json - Nota de Credito</h5>
            <table class="table table-bordered table-sm table-responsive">
              <tr>
